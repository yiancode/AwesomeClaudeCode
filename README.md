...
- **[andybrandt/mcp-simple-openai-assistant](https://github.com/andybrandt/mcp-simple-openai-assistant)** by [andybrandt](https://github.com/andybrandt) - 🐍 ☁️  MCP to talk to OpenAI assistants (Claude can use any GPT model as his assitant)
- **[wanaku-ai/wanaku](https://github.com/wanaku-ai/wanaku)** by [wanaku-ai](https://github.com/wanaku-ai) - ☁️ 🏠 The Wanaku MCP Router is a SSE-based MCP server that provides an extensible routing engine that allows integrating your enterprise systems with AI agents.
- **[QGIS MCP](https://github.com/jjsantos01/qgis_mcp)** by [jjsantos01](https://github.com/jjsantos01) - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
- **[kelvin6365/plane-mcp-server](https://github.com/kelvin6365/plane-mcp-server)** by [kelvin6365](https://github.com/kelvin6365) - 🏎️ 🏠 This MCP Server will help you to manage projects and issues through [Plane's](https://plane.so) API
- **[tan-yong-sheng/ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** by [tan-yong-sheng](https://github.com/tan-yong-sheng) - 📇 🏠 🍎 🪟 🐧 - Multimodal AI vision MCP server for image, video, and object detection analysis. Enables UI/UX evaluation, visual regression testing, and interface understanding using Google Gemini and...
...
- **[ax](https://github.com/Necmttn/ax)** by [Necmttn](https://github.com/Necmttn) `MIT` - Claude Code、Codex、OpenCode、Cursor、Pi 和 Skills 的本地优先遥测与记忆图谱，支持仪表盘、MCP 查询以及成本和会话分析。
